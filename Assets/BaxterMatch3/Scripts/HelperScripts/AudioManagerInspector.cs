    ...
    public class AudioManagerInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            while (i < _script.SFX.Length)
            {
                ...
                do
                {
                    var nameProperty = serializedObject.FindProperty("SFX").GetArrayElementAtIndex(i).FindPropertyRelative("ClipName");
                    var clipProperty = this.serializedObject.FindProperty("SFX").GetArrayElementAtIndex(i).FindPropertyRelative("Clip");
                    var volumeProperty = this.serializedObject.FindProperty("SFX").GetArrayElementAtIndex(i).FindPropertyRelative("Volume");
