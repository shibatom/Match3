...
namespace Internal.Scripts.TargetScripts.TargetSystem
{
    ...
    public abstract class Target
    {
        ...
        {
            MainManager.Instance.levelData.TargetCounters.ForEachY(i=>i.CheckTarget(items));
        }

        public void CheckSquare(Rectangle[] squares)
        {
            MainManager.Instance.levelData.TargetCounters.ForEachY(i=>i.CheckTarget(squares));
        }

        public void CheckSquares(Rectangle[] squares)
        {
             MainManager.Instance.levelData.TargetCounters.ForEachY(i=>i.CheckTarget(squares));
        }
