...
//            item.SetActive(false);
        ...
        private List<Item> GetItemsAround8(Rectangle rectangle)
        {
        ...
        private List<Item> GetItemsAroundSecond(Rectangle rectangle)
        {
            var col = rectangle.col;
            var row = rectangle.row;
            var itemsList = new List<Item>();
        ...
        private List<Item> GetItemsAroundThird(Rectangle rectangle)
        {
            var col = rectangle.col;
            var row = rectangle.row;
            var itemsList = new List<Item>();
        ...
        private Rectangle GetSquare(int col, int row, bool safe = false)
        {
            if (!field)
                field = MainManager.Instance.field;
