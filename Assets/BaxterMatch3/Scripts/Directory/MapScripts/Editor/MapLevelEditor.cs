...
namespace Internal.Scripts.MapScripts.Editor
{
    ...
    public class MapLevelEditor : LevelsEditorBase
    {
        ...
        private void InsertMapLevel(int ind, List<MapLevel> mapLevels)
        {
            ...
            LevelCampaign levelCampaign = FindObjectOfType<LevelCampaign>();
            MapLevel mapLevel = CreateMapLevel(position, ind, levelCampaign.MapLevelPrefab);
            ...
            SetStarsEnabled(levelCampaign, levelCampaign.StarsEnabled);
